...
export default function ChatWindow({ conversationId, isAdmin = false }: ChatWindowProps) {
    ...
    // Scroll to bottom (within chat container only, not the whole page)
            ...
            <form onSubmit={handleSend} className="p-4 bg-white border-t border-slate-200">
                <div className="flex gap-2">
                    ...
                    <button
                        ...
                        className="w-10 h-10 bg-secondary text-white rounded-full flex items-center justify-center hover:opacity-90 disabled:opacity-40 disabled:scale-95 disabled:cursor-not-allowed transition-all shadow-sm"
                    >
                        <Send size={18} />
                    </button>
                </div>
