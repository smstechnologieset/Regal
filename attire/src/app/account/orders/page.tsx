...
import { Package, ChevronRight, Filter, Clock, CheckCircle, XCircle, AlertCircle } from 'lucide-react';
...
export default function OrdersPage() {
    ...
    const getStatusIcon = (status: string) => {
        switch (status) {
            ...
            case 'in_progress': return <AlertCircle size={18} className="text-purple-600" />;
            default: return <Clock size={18} className="text-amber-600" />;
        }
    };
