          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="group bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100">
              ...
              <p className="text-slate-600 mb-6">
                Explore our curated collection of luxury gowns from top
                designers. Available for rent or purchase.
              </p>
              <Link
                href="/bridal/gallery"
            ...
            <div className="group bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100">
              ...
              <p className="text-slate-600 mb-6">
                Professional bridal beauty services including trials, airbrush
                makeup, and updos.
              </p>
              <Link
                href="/bridal/appointments?type=beauty"
                className="inline-flex items-center text-secondary font-medium hover:gap-2 transition-all"
              >
            ...
            <div className="group bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100">
              ...
              <p className="text-slate-600 mb-6">
                Private fitting sessions with our expert stylists to ensure the
                perfect fit and look.
              </p>
              <Link
                href="/bridal/appointments"
                className="inline-flex items-center text-secondary font-medium hover:gap-2 transition-all"
              >
            ...
            <div className="group bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100">
              ...
              <p className="text-slate-600 mb-6">
                Complete your bridal look with our elegant accessories. Veils,
                jewelry, and more available for rent or purchase.
              </p>
              <Link
                href="/bridal/accessories"
                className="inline-flex items-center text-secondary font-medium hover:gap-2 transition-all"
              >
                Browse Accessories <ArrowRight size={16} className="ml-1" />
              </Link>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="text-lg text-slate-600 leading-relaxed">
                ...
                Enjoy champagne while our consultants guide you through our
                collection to find the dress that captures your unique style and
                spirit.
              </p>
