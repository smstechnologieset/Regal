...
const services = [
    {
        ...
        description: 'Discover the latest trends in fashion. Shop our curated collection of clothing, accessories, and more.',
        icon: Shirt,
    ...
    },
    {
        ...
        description: 'From intimate gatherings to grand celebrations. Choose from our packages or create your custom event.',
        icon: PartyPopper,
    ...
    },
    {
        ...
        description: 'Complete bridal solutions including gowns, makeup, hair styling, fittings, and reservations.',
        icon: Heart,
    ...
    },
    {
        ...
        description: 'Premium catering packages for weddings, birthdays, graduations, and corporate events.',
            ...
            <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-slate-900">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        {/* Tagline */}
                        <p className="text-xl md:text-2xl text-white/70 mb-10 max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
                            Your One-Stop Destination for Style, Celebrations, and Unforgettable Experiences
                        </p>
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        ...
                        <p className="text-lg text-slate-600">
                            From fashion to celebrations, we&apos;ve got you covered with our comprehensive range of premium services.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
                        {services.map((service, index) => (
                            <Link
                                ...
                                className={`group relative overflow-hidden rounded-2xl ${!service.available && 'cursor-not-allowed'}`}
                            >
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="absolute -bottom-6 -right-6 bg-white rounded-xl shadow-xl p-6 max-w-xs hidden md:block">
                                <div className="flex items-center gap-3 mb-3">
                                    <div className="flex -space-x-2">
                                        {[1, 2, 3].map((i) => (
                                            <div key={i} className="w-10 h-10 rounded-full bg-gradient-to-br from-rose-400 to-purple-500 border-2 border-white" />
                                        ))}
                                    </div>
                        ...
                        <div>
                            ...
                            <p className="text-lg text-slate-600 mb-8">
                                With over 10 years of experience, Regal has become the go-to destination for premium fashion,
                                unforgettable events, and exceptional service. We take pride in making every moment special.
                            </p>
